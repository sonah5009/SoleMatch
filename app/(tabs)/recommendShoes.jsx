    ...
    if (selectedUser) {
      const fetchShoes = async () => {
        try {
          ...
          const userResponse = await fetch(`${BASE_URL}/user?userName=${selectedUser}`);
          ...
          console.log(`${BASE_URL}/shoes?class=${user.class}&size=${roundedSize}`);
          const shoesResponse = await fetch(`${BASE_URL}/shoes?class=${user.class}&size=${roundedSize}`);
